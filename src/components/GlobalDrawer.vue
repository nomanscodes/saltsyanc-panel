    ...
    <Transition name="drawer">
      ...
      >
        ...
        >
          <!-- gridient  -->
          <svg
            class="absolute top-0 lef-0 bottom-0"
            viewBox="0 0 355 368"
            fill="none"
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <feGaussianBlur
                  stdDeviation="43.85"
                  result="effect1_foregroundBlur_714_18999"
                />
              </filter>
            </defs>
          </svg>
          ...
          <div class="relative">
            ...
            <div
              v-if="$slots.footer"
              class="px-6 py-4 border-t border-[var(--border-primary)] bg-[var(--bg-secondary)]"
            >
