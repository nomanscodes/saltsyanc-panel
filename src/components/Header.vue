<template>
  <header
    class="h-auto md:h-18 flex flex-row items-center justify-between px-4 md:px-6 py-3 md:py-0 gap-3 border-b border-[var(--border-tertiary)]"
  >
    ...
    <div class="flex items-center gap-3 flex-1">
      ...
      <div class="hidden md:block w-full md:max-w-[400px] md:flex-1">
        <InputField
          v-model="searchQuery"
          :icon="Search"
    ...
    <div class="flex items-center gap-2">
      ...
      >
        ...
        >
          <path
            d="M10 1V3M10 17V19M19 10H17M3 10H1M16.364 16.364L14.95 14.95M14.95 5.05L16.364 3.636M3.636 16.364L5.05 14.95M5.05 5.05L3.636 3.636M14 10C14 12.2091 12.2091 14 10 14C7.79086 14 6 12.2091 6 10C6 7.79086 7.79086 6 10 6C12.2091 6 14 7.79086 14 10Z"
            stroke="currentColor"
            stroke-width="2"
            stroke-linecap="round"
            stroke-linejoin="round"
      ...
      <div
        class="hidden md:flex items-center gap-1.5 h-10 bg-[var(--bg-secondary-subtle)] rounded-token-md px-1.5 py-1"
      >
        <!-- Message Icon -->
        <button
      ...
      <div class="relative hidden md:block">
        ...
        >
          <img
            ...
            alt="User Avatar"
            class="w-8 h-8 rounded-5xl object-cover"
          />
          <svg
            width="16"
            height="16"
