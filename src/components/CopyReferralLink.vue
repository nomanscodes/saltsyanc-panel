<template>
  ...
  >
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          />
          <feGaussianBlur
            stdDeviation="56.7168"
            result="effect1_foregroundBlur_540_7203"
          />
        </filter>
      </defs>
    </svg>
    ...
    <div class="relative p-4 sm:p-6 md:p-[var(--spacing-xl3)] flex flex-col">
      <h2
        class="text-lg sm:text-xl md:text-2xl font-bold text-[var(--text-primary-on-brand)] mb-3 md:mb-2"
      >
        Refer a friend and Get ৳10 off. Get up to ৳600.
      </h2>
      <div class="flex flex-col gap-3 md:gap-4 mb-3 md:mb-4">
        <div>
          <span class="text-white text-xs sm:text-sm mb-1 block"
            >Your referral invite link</span
          >
          <div
          ...
          >
            ...
            <Button
              ...
              :disabled="
                referralStore.loading || !referralStore.userProfile.referralLink
              "
              @click="copyLink"
              padding-top="8px"
              padding-bottom="8px"
        ...
        >
          ...
          <div>
            ...
            <img
              ...
              class="w-12 h-12 sm:w-[58px] sm:h-[58px]"
